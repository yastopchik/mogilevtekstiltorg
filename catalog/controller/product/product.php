...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$this->document->addScript('catalog/view/javascript/elevatezoom-min.js');
			...
			if (isset($this->request->get['quick']) && $this->request->get['quick']==1) {
			    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product.tpl')) {
				    $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/productquick.tpl', $data));
			    } else {
