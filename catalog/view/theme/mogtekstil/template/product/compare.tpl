    ...
    <div id="content"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><!--  <input type="button" value="<?php //echo $button_cart; ?>" class="btn btn-primary btn-block canvas-menu" onclick="cart.add('<?php //echo $product['product_id']; ?>');" />-->
            <a href="<?php echo $product['remove']; ?>" class="btn btn-danger btn-block canvas-menu"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      <?php } else { ?>
      ...
      <div class="buttons">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="btn btn-default canvas-menu"><?php echo $button_continue; ?></a></div>
      </div>
      <?php } ?>
