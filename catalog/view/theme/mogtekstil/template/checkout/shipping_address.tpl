<form class="form-horizontal">
    ...
    <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
      ...
      <div class="col-sm-10">
        <div class="input-group date">
          ...
          <button type="button" class="btn btn-default canvas-menu"><i class="fa fa-calendar"></i></button>
          </span></div>
      </div>
    </div>
    <?php } ?>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary canvas-menu" />
    </div>
  </div>
</form>
