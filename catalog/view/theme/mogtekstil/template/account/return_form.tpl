    ...
    <div id="content"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons clearfix">
          <div class="pull-left"><a href="<?php echo $back; ?>" class="btn btn-danger canvas-menu"><?php echo $button_back; ?></a></div>
          <div class="pull-right"><?php echo $text_agree; ?>
            ...
            <?php } ?>
            <input type="submit" value="<?php echo $button_submit; ?>" class="btn btn-primary canvas-menu" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons clearfix">
