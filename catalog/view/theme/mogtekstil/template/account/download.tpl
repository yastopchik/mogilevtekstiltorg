      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="<?php echo $download['href']; ?>" data-toggle="tooltip" title="<?php echo $button_download; ?>" class="btn btn-primary canvas-menu"><i class="fa fa-cloud-download"></i></a></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
